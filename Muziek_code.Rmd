...
#####
t_geh <- ggplot(muziek_main,
       aes(x = genre)) + geom_bar() + xlab("Gender")  + 
  ylab("Count")  + theme_bw()

t_gehg <-  ggplot(muziek_main,
       aes(x = genre, fill = gender)) + geom_bar() + xlab("Gender")  + 
  ylab("Count")  + theme_bw()

ggarrange(t_geh, t_gehg, common.legend = TRUE, legend = "bottom", labels = c("A", "B"))
```
